...
public class GitHubClientViewState: ObservableObject {
...
public struct GitHubClientView: View {
    ...
    public init() {
        self._clientState = StateObject(wrappedValue: GitHubClientViewState())
    }
    
    public init(clientState: GitHubClientViewState) {
